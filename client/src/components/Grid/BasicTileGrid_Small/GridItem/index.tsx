...
const GridItem = ({
  ...
  const content = () => {
    return (
      <div
        className="relative overflow-hidden h-full w-full rounded-lg cursor-pointer bg-cover bg-center hover:bg-[length:105%] hover:bg-[height:105%]"
        style={{
  ...
  if (href) {
    return (
      <Link
        href={href}
        className="rounded-lg w-1/6 max-xl:w-1/2 h-[240px] max-md:h-[150px] p-3 max-md:p-[6px] animate-flip-up animate-duration-1000"
      >
        {content()}
      </Link>
    );
    ...
    return (
      <div className="rounded-lg w-1/6 max-xl:w-1/2 h-[240px] max-md:h-[150px] p-3 max-md:p-[6px] animate-flip-up animate-duration-1000">
        {content()}
      </div>
    );
  }
